...
function swipeBlockedTarget(target){return !!target.closest('dialog,input,select,textarea,button,a,.grade-wheel,.attempt-stepper,.swipe-delete-row,.interactive-chart,.stats-filter-panel')}
